...
from glasses_detector import lit_models
from training.util import DATA_CLASS_MODULE, MODEL_CLASS_MODULE, LIT_MODEL_CLASS_MODULE, import_class, setup_data_and_model_and_lit_model_from_args
...
def _setup_parser():
    ...
    parser.add_argument(
        ...
        help=f"String identifier for model class, relative to {LIT_MODEL_CLASS_MODULE}"
    )
    parser.add_argument(
        "--load_checkpoint",
        type=str,
...
def main():
    ...
    data, model, lit_model_class = setup_data_and_model_and_lit_model_from_args(args)

    if args.load_checkpoint is not None:
        lit_model = lit_model_class.load_from_checkpoint(args.load_from_checkpoint, args=args)
    else:
